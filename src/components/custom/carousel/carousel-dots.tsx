...
>(
  (
    { orientation = "horizontal", dotClassName, dotActiveClassName, ...props },
    ref
  ) => {
      ...
      return (
        ...
        >
          {Array.from({ length: numberOfSlides }, (_, i) => (
            <Button
              key={i}
              className={`mx-1 h-1.5 w-1.5 rounded-full p-0 ${dotClassName} ${
                i === currentSlide
                  ? `${
                      orientation === "horizontal" ? "w-[30px]" : "h-[30px]"
                    } transform bg-[#000000] hover:bg-[#000000] ${dotActiveClassName}`
                  : `bg-[#B1B1B1] hover:bg-[#B1B1B1] ${dotClassName}`
              } `}
