...
import AnimatedGradientBackground from "../background/gradient";
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center h-full">
        <h1 className="text-4xl font-bold">
          <ShinyText text="404" className="text-9xl" />
        </h1>
        <p className="text-2xl">Page Not Found</p>
        <div className="flex items-center gap-4 z-10">
          <Button variant="secondary" asChild className="mt-4 rounded">
            <Link href="/">Contact Admin</Link>
          </Button>
          <Button asChild className="mt-4 rounded">
